                ...
                related.forEach(relatedProduct => {
                    ...
                    card.innerHTML = `
                        <a href="product-detail.html?id=${relatedProduct.id}" class="product-link">
                            <img src="${relatedProduct.image}" alt="${relatedProduct.name}" loading="lazy" decoding="async" width="800" height="600">
                            <div class="product-info">
    ...
    function displayProjects(projectsToDisplay) {
        ...
        projectsToDisplay.forEach(project => {
            ...
            projectCard.innerHTML = `
                <img src="${project.image}" alt="${project.name}" loading="lazy" decoding="async" width="600" height="400">
