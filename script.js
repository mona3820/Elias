...
const projectsData = [
    {
        ...
        category: 'industrial',
        name: 'مشروع مصنع الأغذية (الرياض)',
        description: 'تجهيز نظام تكييف وتهوية متكامل لمصنع أغذية كبير في الرياض، مع ضمان بيئة إنتاج معقمة ومحكمة التحكم في درجة الحرارة والرطوبة.',
        image: 'https://via.placeholder.com/600x400/34495E/F39C12?text=Industrial+Project+1',
        details: {
            sector: 'صناعي',
    ...
    },
    {
        ...
        image: 'https://via.placeholder.com/600x400/2980B9/ECF0F1?text=Commercial+Project+1',
        details: {
            sector: 'تجاري',
    ...
    },
    {
        ...
        image: 'https://via.placeholder.com/600x400/C0392B/F1C40F?text=Healthcare+Project+1',
        details: {
            sector: 'صحي',
    ...
    },
    {
        ...
        image: 'https://via.placeholder.com/600x400/9B59B6/E74C3C?text=Industrial+Project+2',
        details: {
            sector: 'صناعي',
